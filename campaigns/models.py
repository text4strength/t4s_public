...
from campaigns.constants import APPROVED, PENDING, SENT, SENDING, FAILED
...
class Campaign(models.Model):
    ...
    tutorial = models.BooleanField(default=False) # set this conversation as tutorial
...
class TaskQueue(models.Model):
    ...
    twilio = models.ForeignKey(TwilioAccount, null=True)
